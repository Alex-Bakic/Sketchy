...
return (new CustomEvent(event_name,(function (){var obj27738 = {"detail":data};
return obj27738;
})()));
} else {
...
var f = (function (){var pred__27745 = cljs.core._EQ_;
var expr__27746 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27745.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27746))){
return ((function (pred__27745,expr__27746){
return (function (p1__27739_SHARP_){
return console.warn(p1__27739_SHARP_);
});
;})(pred__27745,expr__27746))
} else {
if(cljs.core.truth_(pred__27745.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27746))){
return ((function (pred__27745,expr__27746){
return (function (p1__27740_SHARP_){
return console.debug(p1__27740_SHARP_);
});
;})(pred__27745,expr__27746))
} else {
if(cljs.core.truth_(pred__27745.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27746))){
return ((function (pred__27745,expr__27746){
return (function (p1__27741_SHARP_){
return console.error(p1__27741_SHARP_);
});
;})(pred__27745,expr__27746))
} else {
return ((function (pred__27745,expr__27746){
return (function (p1__27742_SHARP_){
return console.log(p1__27742_SHARP_);
});
;})(pred__27745,expr__27746))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27749){
...
var opts = map__27750__$1;
var eval_fn = cljs.core.get.call(null,map__27750__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27752_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__27754,(0),null);
...
}catch (e27759){if((e27759 instanceof Error)){
var e = e27759;
return not_found;
} else {
throw e27759;
...
//# sourceMappingURL=utils.js.map?rel=1543683807651
