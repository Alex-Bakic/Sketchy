...
var G__22653 = o;
(G__22653[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__22657 = o;
(G__22657[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__22658__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__22659__i < G__22659__a.length) {G__22659__a[G__22659__i] = arguments[G__22659__i + 0]; ++G__22659__i;}
  args = new cljs.core.IndexedSeq(G__22659__a,0,null);
} 
...
var G__22662 = props;
var G__22662__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__22662,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22662);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__22662__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__22663){
...
var props = map__22664__$1;
var class$ = cljs.core.get.call(null,map__22664__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__22664,map__22664__$1,props,class$){
return (function (c){
...
});})(map__22664,map__22664__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__22666){
...
var on_write = cljs.core.get.call(null,map__22667__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__22667,map__22667__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__22667,map__22667__$1,on_write))
);
} else {
...
var G__22670 = jsprops;
(G__22670["defaultValue"] = value);

(G__22670["onChange"] = ((function (G__22670,v,value,on_change){
return (function (p1__22669_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__22669_SHARP_);
});})(G__22670,v,value,on_change))
);
...
var vec__22673 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__22673,(0),null);
var id = cljs.core.nth.call(null,vec__22673,(1),null);
var class$ = cljs.core.nth.call(null,vec__22673,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___22677 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___22677 == null)){
} else {
var key_22678 = temp__5461__auto___22677;
(jsprops["key"] = key_22678);
}
...
var temp__5461__auto___22679 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___22679 == null)){
} else {
var key_22680 = temp__5461__auto___22679;
reagent.impl.template.oset.call(null,jsprops,"key",key_22680);
}
...
var G__22681 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__22681["name"] = c);
...
var len__4641__auto___22686 = arguments.length;
var i__4642__auto___22687 = (0);
while(true){
if((i__4642__auto___22687 < len__4641__auto___22686)){
args__4647__auto__.push((arguments[i__4642__auto___22687]));

var G__22688 = (i__4642__auto___22687 + (1));
i__4642__auto___22687 = G__22688;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq22684){
var G__22685 = cljs.core.first.call(null,seq22684);
var seq22684__$1 = cljs.core.next.call(null,seq22684);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22685,seq22684__$1);
});
...
break;
default:
var G__22691 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__22691;
continue;
...
var n__4518__auto___22693 = a.length;
var i_22694 = (0);
while(true){
if((i_22694 < n__4518__auto___22693)){
(a[i_22694] = reagent.impl.template.as_element.call(null,(a[i_22694])));
...
var a = cljs.core.into_array.call(null,s);
var n__4518__auto___22696 = a.length;
var i_22697 = (0);
while(true){
if((i_22697 < n__4518__auto___22696)){
var val_22698 = (a[i_22697]);
if(((cljs.core.vector_QMARK_.call(null,val_22698)) && ((reagent.impl.template.key_from_vec.call(null,val_22698) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_22697] = reagent.impl.template.as_element.call(null,val_22698));

var G__22699 = (i_22697 + (1));
i_22697 = G__22699;
continue;
} else {
}
...
var ctx = ({});
var vec__22700 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__22700,(0),null);
var derefed = cljs.core.nth.call(null,vec__22700,(1),null);
...
var G__22703 = (cljs.core.count.call(null,argv) - first_child);
switch (G__22703) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__22703){
...
//# sourceMappingURL=template.js.map?rel=1544001705894
