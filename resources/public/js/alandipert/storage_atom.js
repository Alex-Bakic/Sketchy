...
var m__4348__auto__ = (alandipert.storage_atom._get[goog.typeOf(x__4347__auto__)]);
if((!((m__4348__auto__ == null)))){
return m__4348__auto__.call(null,this$,not_found);
} else {
var m__4348__auto____$1 = (alandipert.storage_atom._get["_"]);
if((!((m__4348__auto____$1 == null)))){
return m__4348__auto____$1.call(null,this$,not_found);
} else {
...
var x__4347__auto__ = (((this$ == null))?null:this$);
var m__4348__auto__ = (alandipert.storage_atom._commit_BANG_[goog.typeOf(x__4347__auto__)]);
if((!((m__4348__auto__ == null)))){
return m__4348__auto__.call(null,this$,value);
} else {
var m__4348__auto____$1 = (alandipert.storage_atom._commit_BANG_["_"]);
if((!((m__4348__auto____$1 == null)))){
...
var self__ = this;
var this$__$1 = this;
var temp__5455__auto__ = self__.store.getItem(alandipert.storage_atom.clj__GT_json.call(null,self__.key));
...
alandipert.storage_atom.StorageBackend.cljs$lang$ctorPrWriter = (function (this__4290__auto__,writer__4291__auto__,opt__4292__auto__){
return cljs.core._write.call(null,writer__4291__auto__,"alandipert.storage-atom/StorageBackend");
});
...
var G__22216 = atom;
cljs.core.add_watch.call(null,G__22216,new cljs.core.Keyword("alandipert.storage-atom","storage-watch","alandipert.storage-atom/storage-watch",1159565749),((function (G__22216,existing,debounce){
return (function (p1__22214_SHARP_,p2__22215_SHARP_,p3__22212_SHARP_,p4__22213_SHARP_){
if(((alandipert.storage_atom._STAR_watch_active_STAR_) && (cljs.core.not_EQ_.call(null,p3__22212_SHARP_,p4__22213_SHARP_)))){
return debounce.call(null,((function (G__22216,existing,debounce){
return (function (){
return alandipert.storage_atom._commit_BANG_.call(null,backend,p4__22213_SHARP_);
});})(G__22216,existing,debounce))
,(function (){var or__4047__auto__ = alandipert.storage_atom._STAR_storage_delay_STAR_;
...
var _STAR_watch_active_STAR__orig_val__22217 = alandipert.storage_atom._STAR_watch_active_STAR_;
var _STAR_watch_active_STAR__temp_val__22218 = false;
alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR__temp_val__22218;

try{return cljs.core.reset_BANG_.call(null,atom,default$);
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR__orig_val__22217;
}} else {
try{var temp__5457__auto__ = alandipert.storage_atom.json__GT_clj.call(null,e.key);
if(cljs.core.truth_(temp__5457__auto__)){
var sk = temp__5457__auto__;
if(cljs.core._EQ_.call(null,sk,k)){
var _STAR_watch_active_STAR__orig_val__22220 = alandipert.storage_atom._STAR_watch_active_STAR_;
var _STAR_watch_active_STAR__temp_val__22221 = false;
alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR__temp_val__22221;
...
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR__orig_val__22220;
}} else {
return null;
}
} else {
...
return alandipert.storage_atom.maybe_update_backend.call(null,atom,storage,k,default$,p1__22222_SHARP_);
});})(default$))
);
});
/**
...
//# sourceMappingURL=storage_atom.js.map?rel=1544001704106
